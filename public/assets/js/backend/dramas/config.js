            ...
            var configIndex = new Vue({
                ...
                mounted() {
                    if(Config.site_id == 0){
                        ...
                        //     id: 'usersign',
                        //     title:__('User sign'),
                        //     tip: __('Configure check-in rules'),
                        //     message: __('Sign in coins and continuous sign in rules'),
                        //     icon: 'score-icon',
                        //     leaf: '#EC9371',
                        ...
                        this.configData['platform'] = [{
                            id: 'facebook',
                            title: 'Facebook',
                            tip: __('Facebook configure'),
                            message: __('Facebook app information'),
                            icon: 'Facebook-icon',
                            leaf: '#6990E6',
                            ...
                            id: 'google',
                            title: 'Google',
                            tip: __('Google configure'),
                            message: __('Google app information'),
                            icon: 'Google-icon',
                            leaf: '#EC9371',
                    ...
                    richtextSelect(field, key) {
                        ...
                        Fast.api.open("dramas/richtext/select?lang_k="+key+"&multiple=false", __('Select'), {
                            callback: function (data) {
                                ...
                                }else if(field == 'usersign'){
                                    that.detailForm.richtext[key]['id'] = String(data.data.id);
                                    that.detailForm.richtext[key]['title'] = String(data.data.title);
                                }else{
