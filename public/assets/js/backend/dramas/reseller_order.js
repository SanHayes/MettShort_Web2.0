    ...
    var Controller = {
        index: function () {
            ...
            var orderIndex = new Vue({
                ...
                methods: {
                    goDetail(id) {
                        Fast.api.open('dramas/reseller_order/detail?id=' + id, __('Detail'));
                    },
                    goRecycle() {
                        Fast.api.open('dramas/reseller_order/recyclebin', __('Recycle bin'));
                    },
                    delItem(ids) {
                        var that = this;
                        that.$confirm(__('Are you sure you want to delete this item?'), __('Warning'), {
                            ...
                            Fast.api.ajax({
                                url: 'dramas/reseller_order/del/ids/' + ids,
                                loading: true,
                                type: 'POST',
                            }, function (ret, res) {
                                that.getData();
                    ...
                    getData(offset, limit) {
                        ...
                        Fast.api.ajax({
                            url: 'dramas/reseller_order/index',
                            loading: true,
                            type: 'GET',
                            data: {
            ...
            var vue = new Vue({
                ...
                methods: {
                    getDetail() {
                        let that = this;
                        Fast.api.ajax({
                            url: `dramas/reseller_order/detail?id=${that.orderId}`,
                            loading: true,
                            data: {}
                        }, function (ret, res) {
                    ...
                    goResellerDetail(reseller_id) {
                        Fast.api.open('dramas/reseller/edit?ids=' + reseller_id, __('Edit'));
                    },
                },
            })
        },
