    ...
    var Controller = {
        index: function () {
            ...
            var orderIndex = new Vue({
                ...
                methods: {
                    goDetail(id) {
                        Fast.api.open('dramas/vip_order/detail?id=' + id, __('Detail'));
                    },
                    goRecycle() {
                        Fast.api.open('dramas/vip_order/recyclebin', __('Recycle bin'));
                    },
                    delItem(ids) {
                        var that = this;
                        that.$confirm(__('Are you sure you want to delete this item?'), __('Warning'), {
                            ...
                            Fast.api.ajax({
                                url: 'dramas/vip_order/del/ids/' + ids,
                                loading: true,
                                type: 'POST',
                            }, function (ret, res) {
                                that.getData();
        ...
        recyclebin: function () {
            ...
            table.bootstrapTable({
                url: 'dramas/vip_order/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
            ...
            var vue = new Vue({
                ...
                methods: {
                    getDetail() {
                        let that = this;
                        Fast.api.ajax({
                            url: `dramas/vip_order/detail?id=${that.orderId}`,
                            loading: true,
                            data: {}
                        }, function (ret, res) {
                    ...
                    goVipDetail(vip_id) {
                        Fast.api.open('dramas/vip/edit?ids=' + vip_id, __('Edit'));
                    },
                },
            })
        },
