...
class WechatMenu extends Backend
{
    ...
    /**
     * Wechat模型对象
     * @var \app\admin\model\dramas\Wechat
     */
    ...
    {
        parent::_initialize();
        $this->model = new \app\admin\model\dramas\Wechat;
    }
    ...
    public function copy($id)
    {
        ...
        $menu = new \app\admin\model\dramas\Wechat;
    ...
    {
        $wechat = new \addons\dramas\library\Wechat('wxOfficialAccount');
        try {
    ...
    {
        $dramas = \app\admin\model\dramas\Config::get(['name' => 'dramas', $this->dataLimitField=>$this->auth->id]);
        $dramas = $dramas ? json_decode($dramas->value, true) : ['domain'=>''];
        $wxMiniProgram = \app\admin\model\dramas\Config::get(['name' => 'wxMiniProgram', $this->dataLimitField=>$this->auth->id]);
        $wxMiniProgram = $wxMiniProgram ? json_decode($wxMiniProgram->value, true) : ['app_id'=>''];
        $this->assignconfig('dramas', $dramas);
