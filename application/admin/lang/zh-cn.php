...
return [
    ...
    'Sites' => '站点管理',
    'Management' => '进入管理',
    'No secondary development capability, modification prohibited!' => '没有二次开发能力，禁止修改！',
    'Default Site' => '默认站点',
    'Wap' => '手机端',
    'Authorization' => '授权',
    'Unauthorized' => '未授权',
    ...
    'Withdrawal log' => '提现日志',
    'Parent user' => '设置用户推荐人',
    'VIP order records' => 'VIP订单记录',
    'Login log' => '登录记录',
    'Money log' => '余额明细',
    'Score log' => '积分明细',
    'Share log' => '分享记录',
    'Usable log' => '剧场积分明细',
    'Reseller order log' => '分销商订单记录',
    'Order log' => '订单记录',
    'Wallet log' => '钱包日志',
    'Update' => '更新',
    'Recharge money' => '余额充值',
    'Recharge score' => '积分充值',
    'Recharge usable' => '剧场积分充值',
    'Platform setting' => '平台配置',
    'Block setting' => '区块管理',
    'Notification' => '公告通知',
    'Protocol' => '协议配置',
    'Publish' => '发布',
    ...
    'Copyrights' => '版权分润',
    'Copyright' => '版权方',
    'Copyright order' => '分润记录',
    'Copyright rebate' => '分润提现',
    'Cryptocard' => '卡密管理',
    'Import test data' => '导入测试数据',
    'No data' => '暂无数据',
    'Ad' => '广告管理',
    'Ad log' => '广告记录',
    'Language' => '语言包管理',
