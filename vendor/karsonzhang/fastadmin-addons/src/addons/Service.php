...
use think\Exception;
use think\Log;
use addons\dramas\controller\Base;
use think\Request;
...
class Service extends Base
{
    ...
    public static function isAuthorization($name, $domain = '')
    {
        ...
        $request = request();
        $domain = parent::getRootDomain($domain ? $domain : $request->host(true));
    ...
    public static function unzip($name)
    {
        ...
        $addonsBackupDir = parent::getAddonsBackupDir();
    ...
    {
        $addonsTempDir = parent::getAddonsBackupDir();
...
EOD;
    ...
    public static function upgrade($name, $extend = [])
    {
        ...
        // 远程下载插件
        $tmpFile = parent::download($name, $extend);
    ...
    public static function checkAddonAuthorization($name)
    {
        $request = request();
        $config = self::config($name);
        $domain = parent::getRootDomain($request->host(true));
