...
class UserWalletLog extends Model
{
    ...
    public static $typeAll = [
        ...
        'usersign' => ['code' => 'usersign', 'name' => 'Sign in and receive points'],
        'replenish_usersign' => ['code' => 'replenish_usersign', 'name' => 'Supplementary signature deduction'],
    ...
    {
        if ($memo === '' && $type !== '') {
            $memo = isset(self::$typeAll[$type]) ? __(self::$typeAll[$type]['name']) : '';
        }
