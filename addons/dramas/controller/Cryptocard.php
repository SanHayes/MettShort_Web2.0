...
class Cryptocard extends Base
{
    ...
    protected $noNeedGuest = ['decrypt_card'];
    ...
    private function changeUsable($id,$cryptocard_id)
    {
        ...
        $currency = Lang::where('id', $usable_info['lang_id'])->value('currency');
        ...
        try {
            ...
            User::usable($order->usable, $user, 'cryptocard', $order->id, 'Card exchange',[
                'order_id' => $order->id,
