...
use addons\dramas\library\tpImage\TPImage;
...
class Service
{
    ...
    {
        // 敏感词过滤
        $handle = SensitiveHelper::init()->setTreeByFile(ROOT_PATH . 'addons/dramas/library/data/words.dic');
        //首先检测是否合法
    ...
    {
        $arr = [];
        !defined('_VIC_WORD_DICT_PATH_') && define('_VIC_WORD_DICT_PATH_', ROOT_PATH . 'addons/dramas/library/data/dict.json');
