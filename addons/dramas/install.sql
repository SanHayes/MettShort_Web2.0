...
ALTER TABLE `__PREFIX__dramas_task` ADD COLUMN `lang_id` int(11) NOT NULL DEFAULT 1 COMMENT '语言' AFTER `site_id`;
...
ALTER TABLE `__PREFIX__dramas_video`
    ADD COLUMN `copyright_id` int(11) NOT NULL DEFAULT 0 COMMENT '版权方' AFTER `status`;
ALTER TABLE `__PREFIX__dramas_video_order`
    ADD COLUMN `copyright_id` int(11) NOT NULL DEFAULT 0 COMMENT '版权方' AFTER `platform`;

CREATE TABLE IF NOT EXISTS `__PREFIX__dramas_copyright`  (
    `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
    `site_id` int(10) UNSIGNED NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `__PREFIX__dramas_copyright_order`  (
    `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
    `site_id` int(10) UNSIGNED NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `__PREFIX__dramas_copyright_rebate`  (
    `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
    `site_id` int(10) UNSIGNED NOT NULL DEFAULT 0,
    `copyright_id` int(11) NOT NULL COMMENT '版权方',
...
ALTER TABLE `__PREFIX__user`
    ADD COLUMN `mode` enum('guest','user') NULL DEFAULT 'user' COMMENT '模式:guest=游客,user=用户' AFTER `token`;

ALTER TABLE `__PREFIX__user_group`
    ADD COLUMN `site_id` int(0) NOT NULL COMMENT '站点' AFTER `id`;

ALTER TABLE `__PREFIX__dramas_block`
    ADD COLUMN `url_title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '链接标题' AFTER `url`;

DELETE FROM `__PREFIX__user_rule` WHERE `id` > 0;
INSERT INTO `__PREFIX__user_rule` VALUES (1, 0, 'frontend', 'Frontend', '', 1, 1705649641, 1706852373, 1, 'normal');
INSERT INTO `__PREFIX__user_rule` VALUES (2, 6, '/pages/home/index', 'Index', '', 1, 1705649713, 1706856252, 2, 'normal');
INSERT INTO `__PREFIX__user_rule` VALUES (3, 6, '/pages/home/user', 'User Center', '', 1, 1705649782, 1707034373, 3, 'normal');
INSERT INTO `__PREFIX__user_rule` VALUES (4, 5, '/pages/user/share/index', 'Share', NULL, 1, 1706860828, 1706860828, 4, 'normal');
INSERT INTO `__PREFIX__user_rule` VALUES (5, 1, 'user', 'User', '', 1, 1706855942, 1706855942, 12, 'normal');
INSERT INTO `__PREFIX__user_rule` VALUES (6, 1, 'drama', 'Drama', '', 1, 1706856239, 1706856239, 11, 'normal');
INSERT INTO `__PREFIX__user_rule` VALUES (7, 1, 'current', 'Current', '', 1, 1706856549, 1706856549, 5, 'normal');
INSERT INTO `__PREFIX__user_rule` VALUES (8, 1, 'video', 'Video', '', 1, 1706857527, 1706857527, 9, 'normal');
INSERT INTO `__PREFIX__user_rule` VALUES (10, 5, '/pages/user/integral/index', 'Wallet usable', '', 1, 1706857937, 1707034015, 10, 'normal');
INSERT INTO `__PREFIX__user_rule` VALUES (11, 1, 'market', 'Market', '', 1, 1706858038, 1706858038, 8, 'normal');
INSERT INTO `__PREFIX__user_rule` VALUES (12, 1, 'application', 'Application', '', 1, 1706858190, 1706858190, 6, 'normal');
INSERT INTO `__PREFIX__user_rule` VALUES (13, 7, '/pages/user/richtext', 'Richtext', '参数是协议id', 1, 1706858478, 1707035046, 14, 'normal');
INSERT INTO `__PREFIX__user_rule` VALUES (14, 7, '/pages/video/search', 'Search', '', 1, 1706858497, 1707034686, 26, 'normal');
INSERT INTO `__PREFIX__user_rule` VALUES (15, 7, '/pages/user/info/setting', 'Setting', '', 1, 1706858607, 1707034644, 13, 'normal');
INSERT INTO `__PREFIX__user_rule` VALUES (18, 11, '/pages/user/member/index', 'vip', '', 1, 1706858804, 1707034554, 18, 'normal');
INSERT INTO `__PREFIX__user_rule` VALUES (19, 11, '/pages/user/integral/recharge', 'Usable', '', 1, 1706858816, 1707034535, 19, 'normal');
INSERT INTO `__PREFIX__user_rule` VALUES (20, 12, '/pages/user/signin', 'User sign', '', 1, 1706858864, 1707034622, 20, 'normal');
INSERT INTO `__PREFIX__user_rule` VALUES (21, 5, '/pages/video/record?id=2', 'Video favorite', '', 1, 1706859362, 1707034054, 21, 'normal');
INSERT INTO `__PREFIX__user_rule` VALUES (22, 5, '/pages/video/record?id=1', 'Video log', '', 1, 1706859374, 1707034037, 22, 'normal');
INSERT INTO `__PREFIX__user_rule` VALUES (23, 6, '/pages/video/list', 'Category', '参数是分类id', 1, 1706859447, 1707034798, 23, 'normal');
INSERT INTO `__PREFIX__user_rule` VALUES (24, 5, '/pages/user/info/index', 'User profile', '', 1, 1706859597, 1707034277, 24, 'normal');
INSERT INTO `__PREFIX__user_rule` VALUES (25, 6, '/pages/home/video', 'Recommend', '', 1, 1706859656, 1707034099, 25, 'normal');
INSERT INTO `__PREFIX__user_rule` VALUES (26, 11, '/pages/user/dealer/index', 'Reseller', NULL, 1, 1706860828, 1706860828, 26, 'normal');
INSERT INTO `__PREFIX__user_rule` VALUES (27, 8, '/pages/video/list', 'Video list', '', 1, 1706860810, 1707034474, 27, 'normal');
INSERT INTO `__PREFIX__user_rule` VALUES (28, 8, '/pages/video/play', 'Video detail', '参数是剧的id', 1, 1706860828, 1707034223, 28, 'normal');


CREATE TABLE IF NOT EXISTS `__PREFIX__dramas_notification`  (
    `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID',
    ...
    `deletetime` int(11) NULL DEFAULT NULL,
    PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '公告通知' ROW_FORMAT = Compact;

CREATE TABLE IF NOT EXISTS `__PREFIX__dramas_ad`  (
 `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
 `site_id` int(11) NOT NULL COMMENT '站点',
 `lang_id` int(11) NOT NULL COMMENT '语言',
 ...
 `deletetime` int(11) NULL DEFAULT NULL COMMENT '删除时间',
 PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '广告内容' ROW_FORMAT = Compact;

CREATE TABLE IF NOT EXISTS `__PREFIX__dramas_ad_log`  (
`id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
`site_id` int(11) NOT NULL COMMENT '站点',
`user_id` int(11) NOT NULL COMMENT '用户',
...
`deletetime` int(11) NULL DEFAULT NULL COMMENT '删除时间',
PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '广告记录' ROW_FORMAT = Compact;
